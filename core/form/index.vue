    ...
    <title-bar titleName="表单填写">
      <template slot="tool">
        <span class="tool">
          ...
          <el-button @click="saveDebounce" class="el-button-reset">保存</el-button>
      ...
      <el-form ref="form" label-position="right" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="活动名称:" prop="name">
          <el-input
            ...
            ref="nameRef"
            style="width: 420px;"
            @focus="inputFocus('nameRef', 'form.name', '请输入')"
            @blur="inputBlur('nameRef', 'form.name', '请输入')"
            v-inputie9="{placeholder: '请输入', ref:'nameRef', model:'form.name'}"
          >
          </el-input>
        </el-form-item>
        ...
        <el-form-item label="活动素材:">
          ...
          <div class="upload-success__list">
            <div class="upload-success__item" :key="index" v-for="(file, index) in fileList">
